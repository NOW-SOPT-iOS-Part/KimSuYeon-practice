...
final class SignUpViewController: UIViewController {
    ...
    //1. 요청데이터 만들기
    //회원가입 버튼을 눌렀을 때 각 TextField의 값을 가져와서 서버에 요청할 데이터 객체를 만듦
    @objc private func signUpButtonDidTap() {
        ...
        //SignUpRequestModel에 대한 객체 request를 만듦
        //SignUpRequestModel은 회원가입 API Request Body를 따르고 있음
        //해당 파일 참고
        ...
        //4. 응답받기
        //SignUpResponseModeld의 응답 모델 참고
